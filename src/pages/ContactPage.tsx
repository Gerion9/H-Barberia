...
const IconInstagram = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-instagram instagram-icon" viewBox="0 0 16 16" aria-label="Instagram">
...
const IconCalendar = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-calendar calendar-icon" viewBox="0 0 16 16" aria-label="Calendar">
              ...
              <div className="info-item">
                ...
                <div className="phone-numbers">
                  ...
                  <div>
                    Alejandra: 
                    <IconInstagram />
                    <a href={contactInfo.alejandra.instagram} target="_blank" rel="noopener noreferrer">
                      @alessita.mua
                    </a> 
                  </div>
                  ...
                  <div>
                    Adrian: 
                    <IconCalendar />
                    <a href={contactInfo.adrian.calendar} target="_blank" rel="noopener noreferrer">
                      Reservar Cita
                    </a> 
                  </div>
                </div>
