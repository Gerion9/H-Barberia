  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Conoce al talentoso equipo de H Barbería en Colima: Alberto Cobián, Adrian Denis, Exon y Alejandra Cárdenas. Profesionales dedicados a tu estilo." />
      </Helmet>
